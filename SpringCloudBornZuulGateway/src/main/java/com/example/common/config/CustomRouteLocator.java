...
//    @Autowired
//    private ZuulGatewayDao  zuulGatewayDao;
...
//    }
    ...
    /**该方法就是zuul设置路由规则的地方,
    一是从application.yml读取配置的路由信息，二是从数据库里读取路由信息*/
    @Override
    protected Map<String, ZuulRoute> locateRoutes() {
        ...
        System.out.println("====>从配置文件和数据库中加载完路由信息");
        //优化一下配置
...
//        List<ZuulRouteVO> results =zuulGatewayDao.findByEnable(true);
